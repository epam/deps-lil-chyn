...
@pytest.fixture(
    scope="function",
    params=[
        ("tests/data/docx_file_1.docx", "make_unified_data_1"),
        ("tests/data/docx_file_2.docx", "make_unified_data_2"),
        ("tests/data/docx_file_3.docx", "make_unified_data_3"),
    ],
)
def docx_unified_data(request, fake_storage_service: FakeObjectStorage):
